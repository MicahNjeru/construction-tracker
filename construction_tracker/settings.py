...
# Media URL: the base public URL of media files
MEDIA_URL = '/media/'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Flaire Construction Tracker",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Flaire Construction Tracker Admin",

    # Welcome text on the login screen
    "welcome_sign": "Secure Flaire Construction Tracker",

    # Copyright on the footer
    "copyright": "Flaire Technologies",
}